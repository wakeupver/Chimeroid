...
import com.swordfish.chimeroid.app.utils.android.getGLSLVersion
...
object ShaderChooser {
    ...
    private fun getDefaultShaderForSystem(system: GameSystem): ShaderConfig {
        return when (system.id) {
            ...
            SystemID.DREAMCAST -> ShaderConfig.CRT
    ...
    private fun getConfigForSystem(
        ...
        return when (system.id) {
            ...
            SystemID.DREAMCAST -> upscale32Bits
            SystemID.GAMECUBE -> upscale32Bits
        }
    }
}
