            ...
            ChimeroidControlFaceButtons(
                ...
                idsForegrounds =
                    persistentMapOf<Id.Key, @Composable (State<Boolean>) -> Unit>(
                        Id.Key(KeyEvent.KEYCODE_BUTTON_A) to { ChimeroidButtonForeground(pressed = it, label = "C") },
                        Id.Key(KeyEvent.KEYCODE_BUTTON_B) to { ChimeroidButtonForeground(pressed = it, label = "B") },
                        Id.Key(KeyEvent.KEYCODE_BUTTON_Y) to { ChimeroidButtonForeground(pressed = it, label = "A") },
                    ),
            )
        },
        secondaryDials = {
