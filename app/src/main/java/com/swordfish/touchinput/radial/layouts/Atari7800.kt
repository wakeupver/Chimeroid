            ...
            ChimeroidControlFaceButtons(
                ...
                idsForegrounds =
                    persistentMapOf<Id.Key, @Composable (State<Boolean>) -> Unit>(
                        Id.Key(KeyEvent.KEYCODE_BUTTON_A) to { ChimeroidButtonForeground(pressed = it, label = "2") },
                        Id.Key(KeyEvent.KEYCODE_BUTTON_B) to { ChimeroidButtonForeground(pressed = it, label = "1") },
                    ),
            )
        },
        secondaryDials = {
