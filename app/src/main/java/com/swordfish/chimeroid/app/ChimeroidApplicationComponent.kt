...
import com.swordfish.chimeroid.lib.injection.AndroidWorkerInjectionModule
...
@Component(
    modules = [
        ...
        ChimeroidApplicationModule::class,
...
@PerApp
interface ChimeroidApplicationComponent : AndroidInjector<ChimeroidApplication> {
    @Component.Builder
    abstract class Builder : AndroidInjector.Builder<ChimeroidApplication>()
}
