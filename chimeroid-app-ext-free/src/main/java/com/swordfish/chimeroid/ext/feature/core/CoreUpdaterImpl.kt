...
package com.swordfish.chimeroid.ext.feature.core

import android.content.Context
import android.content.SharedPreferences
import android.net.Uri
import android.os.Build
import com.swordfish.chimeroid.common.files.safeDelete
...
class CoreUpdaterImpl(
    ...
    private suspend fun downloadCoreFromGithub(coreID: CoreID): File {
        ...
        val uri =
            baseUri.buildUpon()
                .appendEncodedPath("raw/$CORES_VERSION/chimeroid_core_${coreID.coreName}/src/main/jniLibs/")
