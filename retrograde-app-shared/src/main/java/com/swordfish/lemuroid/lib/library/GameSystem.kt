            ...
            listOf(
                ...
                GameSystem(
                    ...
                    listOf(
                        SystemCoreConfig(
                            CoreID.SWANSTATION,
                            // Only ONE of these BIOS files is needed to boot PSX games.
                            // openbios.bin is an open-source fallback (all regions).
                            // scph5500/5501/5502 are authentic Sony regional BIOS files.
                            // Using requiredBIOSFilesAnyOf so a user with only e.g.
                            // scph5501.bin is not incorrectly blocked from playing.
                            requiredBIOSFilesAnyOf =
                                listOf(
                                    "openbios.bin",
                                    "scph5500.bin",
                                    "scph5501.bin",
                            ...
                            defaultSettings =
                                listOf(
                                    ...
                                    CoreVariable("swanstation_BIOS_PathNTSCU", "scph5501.bin"),
